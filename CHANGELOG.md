...
- CHANGELOG update [#72](https://github.com/puppetlabs/puppetlabs-facts/pull/72) ([gavindidrichsen](https://github.com/gavindidrichsen))
- (maint) Fix changelog syntax [#66](https://github.com/puppetlabs/puppetlabs-facts/pull/66) ([LukasAud](https://github.com/LukasAud))
- (maint) Add release workflows [#65](https://github.com/puppetlabs/puppetlabs-facts/pull/65) ([LukasAud](https://github.com/LukasAud))
- (maint) Prep for 1.7.0 release [#64](https://github.com/puppetlabs/puppetlabs-facts/pull/64) ([LukasAud](https://github.com/LukasAud))
...
- (maint) Updating the puppet agent compatibility [#62](https://github.com/puppetlabs/puppetlabs-facts/pull/62) ([Ramesh7](https://github.com/Ramesh7))
...
- (maint) Prep for 1.5.0 release [#55](https://github.com/puppetlabs/puppetlabs-facts/pull/55) ([lucywyman](https://github.com/lucywyman))
...
- (maint) Add code of conduct [#53](https://github.com/puppetlabs/puppetlabs-facts/pull/53) ([beechtom](https://github.com/beechtom))
- (maint) Bump maximum Puppet version to include 7.x, prep for release [#52](https://github.com/puppetlabs/puppetlabs-facts/pull/52) ([lucywyman](https://github.com/lucywyman))
...
- (maint) Prep 1.2.0 release [#48](https://github.com/puppetlabs/puppetlabs-facts/pull/48) ([BogdanIrimie](https://github.com/BogdanIrimie))
...
- (maint) Prep 1.1.0 release [#47](https://github.com/puppetlabs/puppetlabs-facts/pull/47) ([beechtom](https://github.com/beechtom))
...
- (GH-42) Format plan metadata for plan parameters [#43](https://github.com/puppetlabs/puppetlabs-facts/pull/43) ([donoghuc](https://github.com/donoghuc))
- (PROTOTYPE)(GH-1981) Add external facts plan [#41](https://github.com/puppetlabs/puppetlabs-facts/pull/41) ([lucywyman](https://github.com/lucywyman))
...
- (MODULES-10513) Prep 1.0.0 release [#38](https://github.com/puppetlabs/puppetlabs-facts/pull/38) ([lucywyman](https://github.com/lucywyman))
- Delegate to facter again [#37](https://github.com/puppetlabs/puppetlabs-facts/pull/37) ([m0dular](https://github.com/m0dular))
...
- (maint) Update broken tests and add CODEOWNERS file [#33](https://github.com/puppetlabs/puppetlabs-facts/pull/33) ([beechtom](https://github.com/beechtom))
...
- aph/modules-9530 [#28](https://github.com/puppetlabs/puppetlabs-facts/pull/28) ([m0dular](https://github.com/m0dular))
...
- (MODULES-8932) Prep for 0.5.1 release [#26](https://github.com/puppetlabs/puppetlabs-facts/pull/26) ([donoghuc](https://github.com/donoghuc))
...
- (MODULES-8717) Move shared dependency to spec_helper [#23](https://github.com/puppetlabs/puppetlabs-facts/pull/23) ([donoghuc](https://github.com/donoghuc))
...
- (MODULES-8456) Do not use custom rake task for test invocation [#21](https://github.com/puppetlabs/puppetlabs-facts/pull/21) ([donoghuc](https://github.com/donoghuc))
- (MODULES-8456) Update testing module tasks [#20](https://github.com/puppetlabs/puppetlabs-facts/pull/20) ([donoghuc](https://github.com/donoghuc))
...
- (MODULES-8403) Prepare 0.5.0 release [#18](https://github.com/puppetlabs/puppetlabs-facts/pull/18) ([MikaelSmith](https://github.com/MikaelSmith))
...
- (BOLT-915) Publish 0.4.1 to Forge [#14](https://github.com/puppetlabs/puppetlabs-facts/pull/14) ([donoghuc](https://github.com/donoghuc))
...
- Read PUPPET_GEM_VERSION [#11](https://github.com/puppetlabs/puppetlabs-facts/pull/11) ([MikaelSmith](https://github.com/MikaelSmith))
...
- Update README for changes in 0.3.0 [#10](https://github.com/puppetlabs/puppetlabs-facts/pull/10) ([MikaelSmith](https://github.com/MikaelSmith))
...
- (maint) update version in metadata to 0.2.0 [#7](https://github.com/puppetlabs/puppetlabs-facts/pull/7) ([donoghuc](https://github.com/donoghuc))
